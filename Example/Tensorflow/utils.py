...
def createDataset():
    labelsFilePath = '/media/save//MLVERTEBRAELABELLING/Labels/'
    volumePath = '/media/save//SmartScrolling/Volumes/'
    X = []
    Y = []
    fileName = []
    ...
    np.save('/media/save//MLVERTEBRAELABELLING/Data/trainData.npy', data)
    np.save('/media/save//MLVERTEBRAELABELLING/Data/trainLabels.npy', targets)
    np.savetxt('/media/save//MLVERTEBRAELABELLING/Data/trainFileName.txt', fileList, fmt="%10s")


def createTestDataset():
    labelsFilePath = '/media/save//MLVERTEBRAELABELLING/TestLabels/'
    volumePath = '/media/save//SmartScrolling/TestVolumes/'
    X = []
    Y = []
    fileName = []
    for file in os.listdir(labelsFilePath):
    ...
    print(data.shape, targets.shape)
    np.save('/media/save//MLVERTEBRAELABELLING/Data/testData.npy', data)
    np.save('/media/save//MLVERTEBRAELABELLING/Data/testLabels.npy', targets)
    np.savetxt('/media/save//MLVERTEBRAELABELLING/Data/testFileName.txt', fileList, fmt="%10s")
...
def visualizeDataLabel(data, label,file):
    ...
    fig.savefig('/media/save//MLVERTEBRAELABELLING/DataVisualization/'+str(file)+'.png')
    plt.close(fig) 
...
def visualizeDataPred(data, label,file):
    ...
    ax[1][0].imshow(np.amax(data, axis = 1))
    ax[1][1].imshow(np.amax(label, axis = 1))
    fig.savefig('/media/save//MLVERTEBRAELABELLING/PredVisualisation/'+str(file)+'.png')
    plt.close(fig) 
...
#     sourceFile = '/home/tristanmary/Desktop//MLVERTEBRAELABELLING/Test/testLabel.h5'
#     dataFile = '/home/tristanmary/Desktop//MLVERTEBRAELABELLING/Test/2038993828Label.h5'
#     labelFile = '/home/tristanmary/Desktop//MLVERTEBRAELABELLING/AugmentedLabels/2038993828.h5'
...
#     sourceFile = '/home//MLVERTEBRAELABELLING/Test/test.h5'
#     for file in os.listdir(dataDirectory):
#         print('Predicting file ', file)
#         augmentedFileDataOpen = h5py.File(dataDirectory + file, 'r+')
#         dataVoxel = augmentedFileDataOpen['ITKImage/0/VoxelData']
