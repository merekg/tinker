...
TEEM_UNU_COMMAND = 'teem-unu resample -s 512 512 512 -k black:3' #TODO: Replace with python resample function
...
if __name__ == '__main__':
    ...
    with h5py.File(viewPath) as outputFile:
        ...
        outputFile.create_dataset('/ITKImage/0/Dimension', data=np.array([512,512,512])) #TODO: Compute from previous dimensions
        ...
        outputFile.create_dataset('/ITKImage/0/Spacing', data=np.array([0.5859375,0.29296875,0.234375])) #TODO: Compute from previous spzcing
