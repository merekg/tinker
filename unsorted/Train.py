...
data, target = utils.loadDataset('/media/save/Shalin/MLVERTEBRAELABELLING/Data/trainData.npy', '/media/save/Shalin/MLVERTEBRAELABELLING/Data/trainLabels.npy', '/media/save/Shalin/MLVERTEBRAELABELLING/Data/trainFileName.txt')
# print(data.shape, target.shape)

# model = utils.createModel()
# model.summary()
# model_path = '/media/save/Shalin/MLVERTEBRAELABELLING/Models/testmodel.h5'
...
model = keras.models.load_model('/media/save/Shalin/MLVERTEBRAELABELLING/Models/testmodel.h5')
...
# testData, testTarget = utils.loadDataset('/media/save/Shalin/MLVERTEBRAELABELLING/Data/testData.npy', '/media/save/Shalin/MLVERTEBRAELABELLING/Data/testLabels.npy', '/media/save/Shalin/MLVERTEBRAELABELLING/Data/testFileName.txt')
...
# labelDirectory = '/home/shalin/MLVERTEBRAELABELLING/Labels/NewLabels/'
...
# # # /media/save/Shalin/MLVERTEBRAELABELLING/Models/model_11_Feb.h5
# # /media/save/Shalin/MLVERTEBRAELABELLING/Models/Tested/model_16_FebFull.h5
# # /media/save/Shalin/MLVERTEBRAELABELLING/Models/model_full_run.h5
