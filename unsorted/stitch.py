...
RECONSTRUCTION_STITCHING_FLAGS = ['--DisplayVolumeGeometry.VoxelSizeMM=0.72,0.72,0.72', '--DisplayVolumeGeometry.MaxVolumeExtentMM=600,400,400', '--quitAfterDual', '--FileIO.SaveAcquisition=false']
...
if __name__ == '__main__':
    ...
    # Modify second acquisition to be a dual type 
    ...
    reconCommand = [RECONSTRUCTION_APP] + RECONSTRUCTION_STITCHING_FLAGS + ['--stitchingTranslationMM=' + str(-1*deltaTranslationMM)]
